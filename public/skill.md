...
4. **情境因素（15%）**：东道主优势、淘汰赛抗压经验、阵容年龄结构，以及**实时出线形势**：
   - 两连败 / 仅剩一场且积分落后 → 「生死战」「必须抢分」，战意与进攻投入上调，平局概率下调
   - 赢球可积 4 分巩固出线 → 更倾向主动进攻，不接受「保平」
   - 已确定晋级 → 可能轮换，战意略降
   - 已出局 → 士气与投入下降
   - 淘汰赛（32强/16强/8强/半决赛/决赛）→ 90 分钟平局进加时/点球，双方都会全力争胜
...
**葡萄牙**（K组）：2025 年欧国联冠军。C罗（41岁，确认最后一届世界杯）、布鲁诺、贝尔纳多、维蒂尼亚、若昂·内维斯。中场豪华。隐忧：CRO的使用方式与更衣室平衡。
